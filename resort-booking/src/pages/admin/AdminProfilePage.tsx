...
const AdminProfilePage: React.FC = () => {
  ...
  const { bookings, settings, updateSettings, refreshSiteData } = useSiteData();
  ...
  useEffect(() => {
    setProfile(mergeAdminProfileFromSettings(settings));
  }, [settings]);
  ...
  const handleProfileSave = (e: React.FormEvent) => {
    ...
    updateSettings(siteSettingsFromAdminProfile(profile));
    refreshSiteData();
    ...
    <AdminLayout currentPage="profile">
      <div className="mb-6">
        ...
        <p className="text-gray-900">
          {activeTab === 'profile'
            ? 'Update contact details shown on the public website and manage your admin account.'
            : 'Configure booking email notifications and verify your SMTP connection.'}
        </p>
      </div>
      ...
      {activeTab === 'profile' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleProfileSave} className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm space-y-6 h-full">
              <h2 className="text-xl font-bold text-gray-900">Personal information</h2>
              <p className="text-sm text-gray-600">
                These details appear on the website footer, contact page, and booking emails. Contact form
                submissions are emailed directly to the admin address on the SMTP tab.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <AdminFormField label="WhatsApp / Phone">
                  <input
                    type="tel"
                    value={profile.phone}
                ...
                <AdminFormField label="Office address" className="sm:col-span-2">
                  <textarea
                    rows={2}
      ...
      {activeTab === 'smtp' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <form onSubmit={handleSmtpSave} className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm space-y-6 h-full">
