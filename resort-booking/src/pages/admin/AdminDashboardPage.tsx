    ...
    <AdminLayout currentPage="dashboard">
      ...
      <div className="bg-white rounded-xl border p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Link to="/admin/settings" className="px-4 py-2 bg-gray-100 rounded-lg text-base font-medium hover:bg-gray-200">Edit site content</Link>
          <Link to="/" className="px-4 py-2 bg-red-500 text-white rounded-lg text-base font-medium">View live site</Link>
        </div>
      </div>
    </AdminLayout>
  );
